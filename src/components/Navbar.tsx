    ...
    <>
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="hidden md:inline-flex bg-gradient-to-r from-orange-500 to-red-600 text-white border-0 hover:opacity-90 gap-2"
              >
          ...
          {/* Mobile AI Button (Added for completeness) */}
          <div className="mt-2 md:hidden">
            <Button
              onClick={() => setIsAssistantOpen(true)}
              className="w-full bg-gradient-to-r from-orange-500 to-red-600 text-white border-0 hover:opacity-90 gap-2"
            >
              <Sparkles className="h-4 w-4" />
              Ask AI Assistant
            </Button>
      ...
      <RecipeAssistant open={isAssistantOpen} onOpenChange={setIsAssistantOpen} />
    </>
  );
};
